...
class FurnaceGUI {
  ...
  bool collapseWindow, demandScrollX, fancyPattern, firstFrame, tempoView, waveHex, waveSigned, waveGenVisible, lockLayout, editOptsVisible, latchNibble;
  ...
  void drawInsC64(DivInstrument* ins);
  void drawInsAmiga(DivInstrument* ins);
  void drawInsPCE(DivInstrument* ins);
  void drawInsAY(DivInstrument* ins);
  void drawInsAY8930(DivInstrument* ins);
  void drawInsTIA(DivInstrument* ins);
  void drawInsSAA1099(DivInstrument* ins);
  void drawInsPET(DivInstrument* ins);
  void drawInsVRC6(DivInstrument* ins);
  void drawInsFDS(DivInstrument* ins);
  void drawInsVBOY(DivInstrument* ins);
  void drawInsN163(DivInstrument* ins);
  void drawInsSCC(DivInstrument* ins);
  void drawInsPOKEY(DivInstrument* ins);
  void drawInsBEEPER(DivInstrument* ins);
  ...
  void drawInsMULTIPCM(DivInstrument* ins);
  void drawInsSNES(DivInstrument* ins);
  void drawInsSU(DivInstrument* ins);
  void drawInsNAMCO(DivInstrument* ins);
  void drawInsNES(DivInstrument* ins);
  void drawInsMSM6258(DivInstrument* ins);
  void drawInsMSM6295(DivInstrument* ins);
  void drawInsADPCMA(DivInstrument* ins);
  void drawInsADPCMB(DivInstrument* ins);
  void drawInsSEGAPCM(DivInstrument* ins);
  void drawInsQSOUND(DivInstrument* ins);
  void drawInsYMZ280B(DivInstrument* ins);
  void drawInsRF5C68(DivInstrument* ins);
  void drawInsMSM5232(DivInstrument* ins);
  void drawInsT6W28(DivInstrument* ins);
  void drawInsK007232(DivInstrument* ins);
  void drawInsGA20(DivInstrument* ins);
  void drawInsPOKEMINI(DivInstrument* ins);
  void drawInsSM8521(DivInstrument* ins);
  void drawInsPV1000(DivInstrument* ins);
  void drawInsK053260(DivInstrument* ins);
  void drawInsTED(DivInstrument* ins);
