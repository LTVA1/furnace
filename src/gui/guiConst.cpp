...
const char* insTypes[DIV_INS_MAX+1][3]={
  ...
  {"Generic Sample##sggc",ICON_FA_VOLUME_UP,ICON_FUR_INS_AMIGA},
  ...
  {"Beeper##sggc",ICON_FA_SQUARE,ICON_FUR_INS_BEEPER},
  ...
  {"VRC6 (saw)##sggc",ICON_FA_BAR_CHART,ICON_FUR_INS_VRC6_SAW},
  ...
  {"OPL (drums)##sggc",ICON_FA_COFFEE,ICON_FUR_INS_OPL_DRUMS},
  ...
  {"DAVE##sggc",ICON_FA_VOLUME_UP,ICON_FA_QUESTION},
...
const FurnaceGUIActionDef guiActions[GUI_ACTION_MAX]={
  D("GLOBAL_MIN", "---Global##sggc", NOT_AN_ACTION),
  D("NEW", "New##sggc", FURKMOD_CMD|SDLK_n),
  D("OPEN", "Open file##sggc", FURKMOD_CMD|SDLK_o),
  D("OPEN_BACKUP", "Restore backup##sggc", 0),
  D("SAVE", "Save file##sggc", FURKMOD_CMD|SDLK_s),
  D("SAVE_AS", "Save as##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_s),
  D("EXPORT", "Export##sggc", 0),
  D("UNDO", "Undo##sggc", FURKMOD_CMD|SDLK_z),
#ifdef __APPLE__
  D("REDO", "Redo##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_z),
#else
  ...
  D("PLAY", "Play##sggc", 0),
  D("STOP", "Stop##sggc", 0),
  D("PLAY_START", "Play (from beginning)##sggc", SDLK_F5),
  D("PLAY_REPEAT", "Play (repeat pattern)##sggc", 0),
  D("PLAY_CURSOR", "Play from cursor##sggc", FURKMOD_SHIFT|SDLK_RETURN),
  D("STEP_ONE", "Step row##sggc", FURKMOD_CMD|SDLK_RETURN),
  D("OCTAVE_UP", "Octave up##sggc", SDLK_KP_MULTIPLY),
  D("OCTAVE_DOWN", "Octave down##sggc", SDLK_KP_DIVIDE),
  D("INS_UP", "Previous instrument##sggc", FURKMOD_SHIFT|SDLK_KP_DIVIDE),
  D("INS_DOWN", "Next instrument##sggc", FURKMOD_SHIFT|SDLK_KP_MULTIPLY),
  D("STEP_UP", "Increase edit step##sggc", FURKMOD_CMD|SDLK_KP_MULTIPLY),
  D("STEP_DOWN", "Decrease edit step##sggc", FURKMOD_CMD|SDLK_KP_DIVIDE),
  D("TOGGLE_EDIT", "Toggle edit mode##sggc", SDLK_SPACE),
  D("METRONOME", "Metronome##sggc", FURKMOD_CMD|SDLK_m),
  D("REPEAT_PATTERN", "Toggle repeat pattern##sggc", 0),
  D("FOLLOW_ORDERS", "Follow orders##sggc", 0),
  D("FOLLOW_PATTERN", "Follow pattern##sggc", 0),
  D("FULLSCREEN", "Toggle full-screen##sggc", SDLK_F11),
  D("TX81Z_REQUEST", "Request voice from TX81Z##sggc", 0),
  D("PANIC", "Panic##sggc", SDLK_F12),
  D("CLEAR", "Clear song data##sggc", 0),

  D("WINDOW_EDIT_CONTROLS", "Edit Controls##sggc", 0),
  D("WINDOW_ORDERS", "Orders##sggc", 0),
  D("WINDOW_INS_LIST", "Instrument List##sggc", 0),
  D("WINDOW_INS_EDIT", "Instrument Editor##sggc", 0),
  D("WINDOW_SONG_INFO", "Song Information##sggc", 0),
  D("WINDOW_SPEED", "Speed##sggc1", 0),
  D("WINDOW_PATTERN", "Pattern##sggc", 0),
  D("WINDOW_WAVE_LIST", "Wavetable List##sggc", 0),
  D("WINDOW_WAVE_EDIT", "Wavetable Editor##sggc", 0),
  D("WINDOW_SAMPLE_LIST", "Sample List##sggc", 0),
  D("WINDOW_SAMPLE_EDIT", "Sample Editor##sggc", 0),
  D("WINDOW_ABOUT", "About##sggc", 0),
#ifdef __APPLE__
  D("WINDOW_SETTINGS", "Settings##sggc", FURKMOD_CMD|SDLK_COMMA),
#else
  D("WINDOW_SETTINGS", "Settings##sggc", 0),
#endif
  D("WINDOW_MIXER", "Mixer##sggc", 0),
  D("WINDOW_DEBUG", "Debug Menu##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_d),
  D("WINDOW_OSCILLOSCOPE", "Oscilloscope (master)##sggc", 0),
  D("WINDOW_VOL_METER", "Volume Meter##sggc", 0),
  D("WINDOW_STATS", "Statistics##sggc", 0),
  D("WINDOW_COMPAT_FLAGS", "Compatibility Flags##sggc", 0),
  D("WINDOW_PIANO", "Piano##sggc", 0),
  D("WINDOW_NOTES", "Song Comments##sggc", 0),
  D("WINDOW_CHANNELS", "Channels##sggc", 0),
  D("WINDOW_PAT_MANAGER", "Pattern Manager##sggc", 0),
  D("WINDOW_SYS_MANAGER", "Chip Manager##sggc", 0),
  D("WINDOW_REGISTER_VIEW", "Register View##sggc", 0),
  D("WINDOW_LOG", "Log Viewer##sggc", 0),
  D("WINDOW_EFFECT_LIST", "Effect List##sggc", 0),
  D("WINDOW_CHAN_OSC", "Oscilloscope (per-channel)##sggc", 0),
  D("WINDOW_SUBSONGS", "Subsongs##sggc", 0),
  D("WINDOW_FIND", "Find/Replace##sggc", FURKMOD_CMD|SDLK_f),
  ...
  D("PAT_MIN", "---Pattern##sggc", NOT_AN_ACTION),
  D("PAT_NOTE_UP", "Transpose (+1)##sggc", FURKMOD_CMD|SDLK_F2),
  D("PAT_NOTE_DOWN", "Transpose (-1)##sggc", FURKMOD_CMD|SDLK_F1),
  D("PAT_OCTAVE_UP", "Transpose (+1 octave)##sggc", FURKMOD_CMD|SDLK_F4),
  D("PAT_OCTAVE_DOWN", "Transpose (-1 octave)##sggc", FURKMOD_CMD|SDLK_F3),
  D("PAT_VALUE_UP", "Increase values (+1)##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_F2),
  D("PAT_VALUE_DOWN", "Increase values (-1)##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_F1),
  D("PAT_VALUE_UP_COARSE", "Increase values (+16)##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_F4),
  D("PAT_VALUE_DOWN_COARSE", "Increase values (-16)##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_F3),
  D("PAT_SELECT_ALL", "Select all##sggc0", FURKMOD_CMD|SDLK_a),
  D("PAT_CUT", "Cut##sggc0", FURKMOD_CMD|SDLK_x),
  D("PAT_COPY", "Copy##sggc0", FURKMOD_CMD|SDLK_c),
  D("PAT_PASTE", "Paste##sggc0", FURKMOD_CMD|SDLK_v),
  D("PAT_PASTE_MIX", "Paste Mix (foreground)##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_v),
  D("PAT_PASTE_MIX_BG", "Paste Mix (background)##sggc", 0),
  D("PAT_PASTE_FLOOD", "Paste Flood##sggc", 0),
  D("PAT_PASTE_OVERFLOW", "Paste Overflow##sggc", 0),
  D("PAT_CURSOR_UP", "Move cursor up##sggc", SDLK_UP),
  D("PAT_CURSOR_DOWN", "Move cursor down##sggc", SDLK_DOWN),
  D("PAT_CURSOR_LEFT", "Move cursor left##sggc", SDLK_LEFT),
  D("PAT_CURSOR_RIGHT", "Move cursor right##sggc", SDLK_RIGHT),
  D("PAT_CURSOR_UP_ONE", "Move cursor up by one (override Edit Step)##sggc", FURKMOD_SHIFT|SDLK_HOME),
  D("PAT_CURSOR_DOWN_ONE", "Move cursor down by one (override Edit Step)##sggc", FURKMOD_SHIFT|SDLK_END),
  D("PAT_CURSOR_LEFT_CHANNEL", "Move cursor to previous channel##sggc", 0),
  D("PAT_CURSOR_RIGHT_CHANNEL", "Move cursor to next channel##sggc", 0),
  D("PAT_CURSOR_NEXT_CHANNEL", "Move cursor to next channel (overflow)##sggc", 0),
  D("PAT_CURSOR_PREVIOUS_CHANNEL", "Move cursor to previous channel (overflow)##sggc", 0),
  D("PAT_CURSOR_BEGIN", "Move cursor to beginning of pattern##sggc", SDLK_HOME),
  D("PAT_CURSOR_END", "Move cursor to end of pattern##sggc", SDLK_END),
  D("PAT_CURSOR_UP_COARSE", "Move cursor up (coarse)##sggc", SDLK_PAGEUP),
  D("PAT_CURSOR_DOWN_COARSE", "Move cursor down (coarse)##sggc", SDLK_PAGEDOWN),
  D("PAT_SELECTION_UP", "Expand selection upwards##sggc", FURKMOD_SHIFT|SDLK_UP),
  D("PAT_SELECTION_DOWN", "Expand selection downwards##sggc", FURKMOD_SHIFT|SDLK_DOWN),
  D("PAT_SELECTION_LEFT", "Expand selection to the left##sggc", FURKMOD_SHIFT|SDLK_LEFT),
  D("PAT_SELECTION_RIGHT", "Expand selection to the right##sggc", FURKMOD_SHIFT|SDLK_RIGHT),
  D("PAT_SELECTION_UP_ONE", "Expand selection upwards by one (override Edit Step)##sggc", 0),
  D("PAT_SELECTION_DOWN_ONE", "Expand selection downwards by one (override Edit Step)##sggc", 0),
  D("PAT_SELECTION_BEGIN", "Expand selection to beginning of pattern##sggc", 0),
  D("PAT_SELECTION_END", "Expand selection to end of pattern##sggc", 0),
  D("PAT_SELECTION_UP_COARSE", "Expand selection upwards (coarse)##sggc", FURKMOD_SHIFT|SDLK_PAGEUP),
  D("PAT_SELECTION_DOWN_COARSE", "Expand selection downwards (coarse)##sggc", FURKMOD_SHIFT|SDLK_PAGEDOWN),
  D("PAT_DELETE", "Delete##sggc", SDLK_DELETE),
  D("PAT_PULL_DELETE", "Pull delete##sggc", SDLK_BACKSPACE),
  D("PAT_INSERT", "Insert##sggc", SDLK_INSERT),
  D("PAT_MUTE_CURSOR", "Mute channel at cursor##sggc", FURKMOD_ALT|SDLK_F9),
  D("PAT_SOLO_CURSOR", "Solo channel at cursor##sggc", FURKMOD_ALT|SDLK_F10),
  D("PAT_UNMUTE_ALL", "Unmute all channels##sggc", FURKMOD_ALT|FURKMOD_SHIFT|SDLK_F9),
  D("PAT_NEXT_ORDER", "Go to next order##sggc", 0),
  D("PAT_PREV_ORDER", "Go to previous order##sggc", 0),
  D("PAT_COLLAPSE", "Collapse channel at cursor##sggc", 0),
  D("PAT_INCREASE_COLUMNS", "Increase effect columns##sggc", 0),
  D("PAT_DECREASE_COLUMNS", "Decrease effect columns##sggc", 0),
  D("PAT_INTERPOLATE", "Interpolate##sggc", 0),
  D("PAT_FADE", "Fade##sggc", 0),
  D("PAT_INVERT_VALUES", "Invert values##sggc", 0),
  D("PAT_FLIP_SELECTION", "Flip selection##sggc", 0),
  D("PAT_COLLAPSE_ROWS", "Collapse rows##sggc", 0),
  D("PAT_EXPAND_ROWS", "Expand rows##sggc", 0),
  D("PAT_COLLAPSE_PAT", "Collapse pattern##sggc", 0),
  D("PAT_EXPAND_PAT", "Expand pattern##sggc", 0),
  D("PAT_COLLAPSE_SONG", "Collapse song##sggc", 0),
  D("PAT_EXPAND_SONG", "Expand song##sggc", 0),
  ...
  D("INS_LIST_ADD", "Add##sggc0", SDLK_INSERT),
  D("INS_LIST_DUPLICATE", "Duplicate##sggc0", FURKMOD_CMD|SDLK_d),
  D("INS_LIST_OPEN", "Open##sggc0", 0),
  D("INS_LIST_OPEN_REPLACE", "Open (replace current)##sggc0", 0),
  D("INS_LIST_SAVE", "Save##sggc0", 0),
  D("INS_LIST_SAVE_DMP", "Export (.dmp)##sggc", 0),
  D("INS_LIST_MOVE_UP", "Move up##sggc0", FURKMOD_SHIFT|SDLK_UP),
  D("INS_LIST_MOVE_DOWN", "Move down##sggc0", FURKMOD_SHIFT|SDLK_DOWN),
  D("INS_LIST_DELETE", "Delete##sggc0", 0),
  D("INS_LIST_EDIT", "Edit##sggc0", FURKMOD_SHIFT|SDLK_RETURN),
  D("INS_LIST_UP", "Cursor up##sggc0", SDLK_UP),
  D("INS_LIST_DOWN", "Cursor down##sggc0", SDLK_DOWN),
  D("INS_LIST_DIR_VIEW", "Toggle folders/standard view##sggc0", FURKMOD_CMD|SDLK_v),
  D("INS_LIST_MAX", "", NOT_AN_ACTION),

  D("WAVE_LIST_MIN", "---Wavetable list##sggc", NOT_AN_ACTION),
  D("WAVE_LIST_ADD", "Add##sggc1", SDLK_INSERT),
  D("WAVE_LIST_DUPLICATE", "Duplicate##sggc1", FURKMOD_CMD|SDLK_d),
  D("WAVE_LIST_OPEN", "Open##sggc1", 0),
  D("WAVE_LIST_OPEN_REPLACE", "Open (replace current)##sggc1", 0),
  D("WAVE_LIST_SAVE", "Save##sggc1", 0),
  D("WAVE_LIST_SAVE_DMW", "Save (.dmw)##sggc", 0),
  D("WAVE_LIST_SAVE_RAW", "Save (raw)##sggc0", 0),
  D("WAVE_LIST_MOVE_UP", "Move up##sggc1", FURKMOD_SHIFT|SDLK_UP),
  D("WAVE_LIST_MOVE_DOWN", "Move down##sggc1", FURKMOD_SHIFT|SDLK_DOWN),
  D("WAVE_LIST_DELETE", "Delete##sggc1", 0),
  D("WAVE_LIST_EDIT", "Edit##sggc1", FURKMOD_SHIFT|SDLK_RETURN),
  D("WAVE_LIST_UP", "Cursor up##sggc1", SDLK_UP),
  D("WAVE_LIST_DOWN", "Cursor down##sggc1", SDLK_DOWN),
  D("WAVE_LIST_DIR_VIEW", "Toggle folders/standard view##sggc1", FURKMOD_CMD|SDLK_v),
  D("WAVE_LIST_MAX", "", NOT_AN_ACTION),

  D("SAMPLE_LIST_MIN", "---Sample list##sggc", NOT_AN_ACTION),
  D("SAMPLE_LIST_ADD", "Add##sggc2", SDLK_INSERT),
  D("SAMPLE_LIST_DUPLICATE", "Duplicate##sggc2", FURKMOD_CMD|SDLK_d),
  D("SAMPLE_LIST_OPEN", "Open##sggc2", 0),
  D("SAMPLE_LIST_OPEN_REPLACE", "Open (replace current)##sggc2", 0),
  D("SAMPLE_LIST_OPEN_RAW", "Import raw data##sggc", 0),
  D("SAMPLE_LIST_OPEN_REPLACE_RAW", "Import raw data (replace current)##sggc", 0),
  D("SAMPLE_LIST_SAVE", "Save##sggc2", 0),
  D("SAMPLE_LIST_SAVE_RAW", "Save (raw)##sggc1", 0),
  D("SAMPLE_LIST_MOVE_UP", "Move up##sggc2", FURKMOD_SHIFT|SDLK_UP),
  D("SAMPLE_LIST_MOVE_DOWN", "Move down##sggc2", FURKMOD_SHIFT|SDLK_DOWN),
  D("SAMPLE_LIST_DELETE", "Delete##sggc2", 0),
  D("SAMPLE_LIST_EDIT", "Edit##sggc2", FURKMOD_SHIFT|SDLK_RETURN),
  D("SAMPLE_LIST_UP", "Cursor up##sggc2", SDLK_UP),
  D("SAMPLE_LIST_DOWN", "Cursor down##sggc2", SDLK_DOWN),
  ...
  D("SAMPLE_SELECT", "Edit mode: Select##sggc", FURKMOD_SHIFT|SDLK_i),
  D("SAMPLE_DRAW", "Edit mode: Draw##sggc", FURKMOD_SHIFT|SDLK_d),
  D("SAMPLE_CUT", "Cut##sggc1", FURKMOD_CMD|SDLK_x),
  D("SAMPLE_COPY", "Copy##sggc1", FURKMOD_CMD|SDLK_c),
  D("SAMPLE_PASTE", "Paste##sggc1", FURKMOD_CMD|SDLK_v),
  D("SAMPLE_PASTE_REPLACE", "Paste replace##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_v),
  D("SAMPLE_PASTE_MIX", "Paste mix##sggc", FURKMOD_CMD|FURKMOD_ALT|SDLK_v),
  D("SAMPLE_SELECT_ALL", "Select all##sggc1", FURKMOD_CMD|SDLK_a),
  D("SAMPLE_RESIZE", "Resize##sggc", FURKMOD_CMD|SDLK_r),
  D("SAMPLE_RESAMPLE", "Resample##sggc", FURKMOD_CMD|SDLK_e),
  D("SAMPLE_AMPLIFY", "Amplify##sggc", FURKMOD_CMD|SDLK_b),
  D("SAMPLE_NORMALIZE", "Normalize##sggc", FURKMOD_CMD|SDLK_n),
  D("SAMPLE_FADE_IN", "Fade in##sggc", FURKMOD_CMD|SDLK_i),
  D("SAMPLE_FADE_OUT", "Fade out##sggc", FURKMOD_CMD|SDLK_o),
  D("SAMPLE_SILENCE", "Apply silence##sggc", FURKMOD_SHIFT|SDLK_DELETE),
  D("SAMPLE_INSERT", "Insert silence##sggc", SDLK_INSERT),
  D("SAMPLE_DELETE", "Delete##sggc3", SDLK_DELETE),
  D("SAMPLE_TRIM", "Trim##sggc", FURKMOD_CMD|SDLK_DELETE),
  D("SAMPLE_REVERSE", "Reverse##sggc", FURKMOD_CMD|SDLK_t),
  D("SAMPLE_INVERT", "Invert##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_t),
  D("SAMPLE_SIGN", "Signed/unsigned exchange##sggc", FURKMOD_CMD|SDLK_u),
  D("SAMPLE_FILTER", "Apply filter##sggc", FURKMOD_CMD|SDLK_f),
  D("SAMPLE_CROSSFADE_LOOP", "Crossfade loop points##sggc", NOT_AN_ACTION),
  D("SAMPLE_PREVIEW", "Preview sample##sggc", 0),
  D("SAMPLE_STOP_PREVIEW", "Stop sample preview##sggc", 0),
  D("SAMPLE_ZOOM_IN", "Zoom in##sggc", FURKMOD_CMD|SDLK_EQUALS),
  D("SAMPLE_ZOOM_OUT", "Zoom out##sggc", FURKMOD_CMD|SDLK_MINUS),
  D("SAMPLE_ZOOM_AUTO", "Toggle auto-zoom##sggc", FURKMOD_CMD|SDLK_0),
  D("SAMPLE_MAKE_INS", "Create instrument from sample##sggc", 0),
  D("SAMPLE_SET_LOOP", "Set loop to selection##sggc", FURKMOD_CMD|SDLK_l),
  D("SAMPLE_CREATE_WAVE", "Create wavetable from selection##sggc", FURKMOD_CMD|SDLK_w),
  D("SAMPLE_MAX", "", NOT_AN_ACTION),

  D("ORDERS_MIN", "---Orders##sggc", NOT_AN_ACTION),
  D("ORDERS_UP", "Previous order##sggc", SDLK_UP),
  D("ORDERS_DOWN", "Next order##sggc", SDLK_DOWN),
  D("ORDERS_LEFT", "Cursor left##sggc", SDLK_LEFT),
  D("ORDERS_RIGHT", "Cursor right##sggc", SDLK_RIGHT),
  D("ORDERS_INCREASE", "Increase value##sggc", 0),
  D("ORDERS_DECREASE", "Decrease value##sggc", 0),
  D("ORDERS_EDIT_MODE", "Switch edit mode##sggc", 0),
  D("ORDERS_LINK", "Toggle alter entire row##sggc", FURKMOD_CMD|SDLK_l),
  D("ORDERS_ADD", "Add##sggc3", SDLK_INSERT),
  D("ORDERS_DUPLICATE", "Duplicate##sggc3", FURKMOD_CMD|SDLK_d),
  D("ORDERS_DEEP_CLONE", "Deep clone##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_d),
  D("ORDERS_DUPLICATE_END", "Duplicate to end of song##sggc", FURKMOD_CMD|SDLK_e),
  D("ORDERS_DEEP_CLONE_END", "Deep clone to end of song##sggc", FURKMOD_CMD|FURKMOD_SHIFT|SDLK_e),
  D("ORDERS_REMOVE", "Remove##sggc", SDLK_DELETE),
  D("ORDERS_MOVE_UP", "Move up##sggc3", FURKMOD_SHIFT|SDLK_UP),
  D("ORDERS_MOVE_DOWN", "Move down##sggc3", FURKMOD_SHIFT|SDLK_DOWN),
  D("ORDERS_REPLAY", "Replay##sggc", 0),
...
const FurnaceGUIColorDef guiColors[GUI_COLOR_MAX]={
  ...
  D(GUI_COLOR_INSTR_DAVE,"",ImVec4(1.0f,0.6f,1.0f,1.0f)),
...
// FM
const int chipsFM[]={ //the ones that are commented out are inside collapsible menus!
  DIV_SYSTEM_YM2612,
  //DIV_SYSTEM_YM2612_EXT,
  //DIV_SYSTEM_YM2612_CSM,
  //DIV_SYSTEM_YM2612_DUALPCM,
