...
const char* insTypes[DIV_INS_MAX+1][3]={
  ...
  {"YM2609 FM",ICON_FA_STACK_OVERFLOW,ICON_FUR_INS_YM2609_FM},
  {"YM2609 SSG",ICON_FA_STACK_OVERFLOW,ICON_FUR_INS_YM2609_SSG},
  {"YM2609 RSS",ICON_FA_STACK_OVERFLOW,ICON_FUR_INS_YM2609_RSS},
  {"YM2609 ADPCM-A",ICON_FA_STACK_OVERFLOW,ICON_FUR_INS_YM2609_ADPCM_A},
  {"YM2609 ADPCM-B",ICON_FA_STACK_OVERFLOW,ICON_FUR_INS_YM2609_ADPCM_B},
...
const FurnaceGUIColorDef guiColors[GUI_COLOR_MAX]={
  ...
  D(GUI_COLOR_INSTR_YM2609_FM,"",ImVec4(0.6f,0.45f,0.6f,1.0f)),
  D(GUI_COLOR_INSTR_YM2609_SSG,"",ImVec4(0.9f,0.45f,0.6f,1.0f)),
  D(GUI_COLOR_INSTR_YM2609_RSS,"",ImVec4(0.7f,0.45f,0.9f,1.0f)),
  D(GUI_COLOR_INSTR_YM2609_ADPCM_A,"",ImVec4(1.0f,0.85f,0.6f,1.0f)),
  D(GUI_COLOR_INSTR_YM2609_ADPCM_B,"",ImVec4(1.0f,0.25f,0.9f,1.0f)),
